...
import cv2
import skimage
##This file is used to generate GIOU losses during the second half of training.

class Unet_Train_GIoU(nn.Module):
    def __init__(self):
        super(Unet_Train_GIoU, self).__init__()
    ...
    def forward(self, fake_img, real_img):
        ...
        for i in range(fake.shape[0]): 
            ...
            Threshold = 'Please select your best Threshold for your own dataset' ## the rage of 0.14 (± 0.07) is optimial
            MaxGIoU = -1.0
            MaxDice = -1.0
            while (Threshold != 0):
